        ...
        <div className={s.typeTiles}>
          {REPAIR_TYPES.map((rt) => (
            <button
              ...
              onClick={() => onChange({ ...data, repairType: rt.value })}
            >
        ...
        <div className={s.scopeSection}>
          ...
          <div className={s.row2}>
            <div className={s.fieldGroup}>
              ...
              <input type='number' value={data.extDigFt || ''} onChange={(e) => set('extDigFt')(e.target.value)} placeholder='e.g. 30' />
            </div>
            <div className={s.fieldGroup}>
              <label className={s.label}>Depth</label>
              <input value={data.extDepth || ''} onChange={(e) => set('extDepth')(e.target.value)} placeholder='e.g. 8 ft' />
            </div>
          </div>
          <div className={s.fieldGroup}>
            <label className={s.label}>Obstructions / Access Notes</label>
            <input value={data.extObstructions || ''} onChange={(e) => set('extObstructions')(e.target.value)} placeholder='Fences, A/C units, tight spaces, neighbour access needed, etc.' />
          </div>
        </div>
      )}
        ...
        <div className={s.scopeSection}>
          ...
          <div className={s.row2}>
            <div className={s.fieldGroup}>
              ...
              <input type='number' value={data.intWallFt || ''} onChange={(e) => set('intWallFt')(e.target.value)} placeholder='e.g. 25' />
            </div>
            <div className={s.fieldGroup}>
              <label className={s.label}>Crack Size</label>
              <select value={data.crackSize || ''} onChange={(e) => set('crackSize')(e.target.value)}>
          ...
          <div className={s.row2}>
            <div className={s.fieldGroup}>
              ...
              <input type='number' value={data.weepingTileFt || ''} onChange={(e) => set('weepingTileFt')(e.target.value)} placeholder='e.g. 30' />
            </div>
            <div className={s.fieldGroup}>
              <label className={s.label}>New Sump Pump Required?</label>
              <select value={data.sumpPump || ''} onChange={(e) => set('sumpPump')(e.target.value)}>
                <option value=''>Select...</option>
          ...
          <div className={s.fieldGroup}>
            ...
            <select value={data.drywallCovered || ''} onChange={(e) => set('drywallCovered')(e.target.value)}>
              <option value=''>Select...</option>
          ...
          <div className={s.fieldGroup}>
            ...
            <textarea rows={2} value={data.demoNotes || ''} onChange={(e) => set('demoNotes')(e.target.value)} placeholder='Length, height, carpet, baseboards, tiles, etc.' />
          </div>
        </div>
      )}
        ...
        <div className={s.scopeSection}>
          ...
          <div className={s.row3}>
            <div className={s.fieldGroup}>
              ...
              <input type='number' value={data.gradingFt || ''} onChange={(e) => set('gradingFt')(e.target.value)} placeholder='ft' />
            </div>
            <div className={s.fieldGroup}>
              <label className={s.label}>Paved Concrete — ft</label>
              <input type='number' value={data.concreteFt || ''} onChange={(e) => set('concreteFt')(e.target.value)} placeholder='ft' />
            </div>
            <div className={s.fieldGroup}>
              <label className={s.label}>Grass Seeding — ft</label>
              <input type='number' value={data.grassFt || ''} onChange={(e) => set('grassFt')(e.target.value)} placeholder='ft' />
            </div>
          </div>
        </div>
      )}
